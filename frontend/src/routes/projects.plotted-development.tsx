...
import { plottedProjects } from "@/data/projects-data";

export const Route = createFileRoute("/projects/plotted-development")({
  head: () => ({
    meta: [{ title: "Plotted Development Projects | Nimma Metro" }],
  }),
      ...
      <main className="py-12">
        <div className="container-x">
          <div className="border-b border-border pb-6">
            ...
            <p className="mt-2 text-muted-foreground">Explore our completed and ongoing residential plot projects.</p>
          </div>

          {/* Project Grid */}
          <div className="mt-10 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {plottedProjects.map((p) => (
              <div
                key={p.id}
                ...
                <div className="flex flex-1 flex-col justify-between p-6">
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2 rounded-xl bg-muted/60 p-3 text-center">
                      ...
                      <div>
                        <span className="block text-[11px] uppercase tracking-wider text-muted-foreground">Plot Size</span>
